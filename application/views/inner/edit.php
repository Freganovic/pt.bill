<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        $tanggal = $innerInfo->tanggal;
        $nama = $innerInfo->nama;
        $mars = $innerInfo->mars;
        $bom = $innerInfo->bom;
        $qty = $innerInfo->qty;
        $mesin = $innerInfo->mesin;
        $wo = $innerInfo->wo;
        $io = $innerInfo->io;
        $status = $innerInfo->status;
        ?>
        <h1>
            <i class="fa fa-user-circle-o" aria-hidden="true"></i> Inner Management
            <small>Edit Inner</small>
        </h1>
    </section>
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit Inner Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->

                    <form role="form" action="<?php echo base_url() ?>inner/editInner" method="post" id="editInner"
                        role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $innerId; ?>" name="innerId"
                                            id="innerId" />
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            <option value="pending" <?php echo isset($inner['status']) && $inner['status'] == 'pending' ? 'selected' : ''; ?>>Pending</option>
                                            <option value="complete" <?php echo isset($inner['status']) && $inner['status'] == 'complete' ? 'selected' : ''; ?>>Complete</option>
                                        </select>
                                    </div>
