                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-info"
                                                href="<?php echo base_url() . 'booking/edit/' . $record->bookingId; ?>"
                                                title="Edit"><i class="fa fa-pencil"></i></a>
                                            <a class="btn btn-sm btn-danger deleteBooking" href="#"
                                                data-bookingid="<?php echo $record->bookingId; ?>" title="Delete"><i
