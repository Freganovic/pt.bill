<div class="content-wrapper">
    ...
    <section class="content-header">
        <?php
        $bottom3Id = $bottom3Info->id;
        $tanggal = $bottom3Info->tanggal;
        $nama = $bottom3Info->nama;
        $mars = $bottom3Info->mars;
        $bom = $bottom3Info->bom;
        $qty = $bottom3Info->qty;
        $mesin = $bottom3Info->mesin;
        $wo = $bottom3Info->wo;
        $io = $bottom3Info->io;
        $status = $bottom3Info->status;
        ?>
        <h1>
            <i class="fa fa-user-circle-o" aria-hidden="true"></i> Bottom3 Management
            <small>Edit Bottom3</small>
        </h1>
    </section>
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit Bottom3 Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->

                    <form role="form" action="<?php echo base_url() ?>bottom3/editBottom3" method="post"
                        id="editBottom3" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $bottom3Id; ?>" name="bottom3Id"
                                            id="bottom3Id" />
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            <option value="pending" <?php echo isset($bottom3['status']) && $bottom3['status'] == 'pending' ? 'selected' : ''; ?>>Pending</option>
                                            <option value="complete" <?php echo isset($bottom3['status']) && $bottom3['status'] == 'complete' ? 'selected' : ''; ?>>Complete</option>
                                        </select>
                                    </div>
