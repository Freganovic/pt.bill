<div class="content-wrapper">
    ...
    <section class="content-header">
        <?php
        $bottom2Id = $bottom2Info->id;
        $tanggal = $bottom2Info->tanggal;
        $nama = $bottom2Info->nama;
        $mars = $bottom2Info->mars;
        $bom = $bottom2Info->bom;
        $qty = $bottom2Info->qty;
        $mesin = $bottom2Info->mesin;
        $wo = $bottom2Info->wo;
        $io = $bottom2Info->io;
        $status = $bottom2Info->status;
        ?>
        <h1>
            <i class="fa fa-user-circle-o" aria-hidden="true"></i> Bottom2 Management
            <small>Edit Bottom2</small>
        </h1>
    </section>
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit Bottom2 Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->

                    <form role="form" action="<?php echo base_url() ?>bottom2/editBottom2" method="post"
                        id="editBottom2" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $bottom2Id; ?>" name="bottom2Id"
                                            id="bottom2Id" />
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            <option value="pending" <?php echo isset($bottom2['status']) && $bottom2['status'] == 'pending' ? 'selected' : ''; ?>>Pending</option>
                                            <option value="complete" <?php echo isset($bottom2['status']) && $bottom2['status'] == 'complete' ? 'selected' : ''; ?>>Complete</option>
                                        </select>
                                    </div>
