<div class="content-wrapper">
    ...
    <section class="content-header">
        <?php
        $headId = $headInfo->id;
        $tanggal = $headInfo->tanggal;
        $nama = $headInfo->nama;
        $mars = $headInfo->mars;
        $bom = $headInfo->bom;
        $qty = $headInfo->qty;
        $mesin = $headInfo->mesin;
        $wo = $headInfo->wo;
        $io = $headInfo->io;
        $status = $headInfo->status;
        ?>
        <h1>
            <i class="fa fa-user-circle-o" aria-hidden="true"></i> Head Management
            <small>Edit Head</small>
        </h1>
    </section>
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit Head Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->

                    <form role="form" action="<?php echo base_url() ?>head/editHead" method="post" id="editHead"
                        role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $headId; ?>" name="headId" id="headId" />
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            <option value="pending" <?php echo isset($head['status']) && $head['status'] == 'pending' ? 'selected' : ''; ?>>Pending</option>
                                            <option value="complete" <?php echo isset($head['status']) && $head['status'] == 'complete' ? 'selected' : ''; ?>>Complete</option>
                                        </select>
                                    </div>
