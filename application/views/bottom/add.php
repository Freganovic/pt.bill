            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Bottom Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form role="form" id="addBottom" action="<?php echo base_url() ?>bottom/addNewBottom" method="post"
                        role="form">
