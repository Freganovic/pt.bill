<div class="content-wrapper">
    ...
    <section class="content-header">
        <?php
        $bottomId = $bottomInfo->id;
        $tanggal = $bottomInfo->tanggal;
        $nama = $bottomInfo->nama;
        $mars = $bottomInfo->mars;
        $bom = $bottomInfo->bom;
        $qty = $bottomInfo->qty;
        $mesin = $bottomInfo->mesin;
        $wo = $bottomInfo->wo;
        $io = $bottomInfo->io;
        $status = $bottomInfo->status;
        ?>
        <h1>
            <i class="fa fa-user-circle-o" aria-hidden="true"></i> Bottom Management
            <small>Edit Bottom</small>
        </h1>
    </section>
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit Bottom Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->

                    <form role="form" action="<?php echo base_url() ?>bottom/editBottom" method="post" id="editBottom"
                        role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $bottomId; ?>" name="bottomId"
                                            id="bottomId" />
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            <option value="pending" <?php echo isset($bottom['status']) && $bottom['status'] == 'pending' ? 'selected' : ''; ?>>Pending</option>
                                            <option value="complete" <?php echo isset($bottom['status']) && $bottom['status'] == 'complete' ? 'selected' : ''; ?>>Complete</option>
                                        </select>
                                    </div>
