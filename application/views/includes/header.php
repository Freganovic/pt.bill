  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo base_url(); ?>" class="logo">
        ...
        <span class="logo-mini"><b>BI</b>LL</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>PT.Bumimulia Indah</b>Lestari</span>
      </a>
          ...
          if ($is_admin == 1) {
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url(); ?>project1">Mold</a></li>
                <li><a href="<?php echo base_url(); ?>project2">Second Mold</a></li>
                <li><a href="<?php echo base_url(); ?>project3">Blowpin</a></li>
                <li><a href="<?php echo base_url(); ?>project4">Diepin</a></li>
              </ul>
