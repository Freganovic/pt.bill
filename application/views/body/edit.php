<div class="content-wrapper">
    ...
    <section class="content-header">
        <?php
        $bodyId = $bodyInfo->id;
        $tanggal = $bodyInfo->tanggal;
        $nama = $bodyInfo->nama;
        $mars = $bodyInfo->mars;
        $bom = $bodyInfo->bom;
        $qty = $bodyInfo->qty;
        $mesin = $bodyInfo->mesin;
        $wo = $bodyInfo->wo;
        $io = $bodyInfo->io;
        $status = $bodyInfo->status;
        ?>
        <h1>
            <i class="fa fa-user-circle-o" aria-hidden="true"></i> Body Management
            <small>Edit Body</small>
        </h1>
    </section>
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit Body Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->

                    <form role="form" action="<?php echo base_url() ?>body/editBody" method="post" id="editBody"
                        role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $bodyId; ?>" name="bodyId" id="bodyId" />
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            <option value="pending" <?php echo isset($body['status']) && $body['status'] == 'pending' ? 'selected' : ''; ?>>Pending</option>
                                            <option value="complete" <?php echo isset($body['status']) && $body['status'] == 'complete' ? 'selected' : ''; ?>>Complete</option>
                                        </select>
                                    </div>
