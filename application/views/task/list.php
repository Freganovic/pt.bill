        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>task/add"><i class="fa fa-plus"></i> Add
                        New task</a>
                </div>
            </div>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-info"
                                                href="<?php echo base_url() . 'task/edit/' . $record->taskId; ?>" title="Edit">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a class="btn btn-sm btn-danger deleteUser" href="#"
                                                data-roleid="<?php echo $record->taskId; ?>" title="Delete"><i
