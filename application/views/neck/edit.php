<div class="content-wrapper">
    ...
    <section class="content-header">
        <?php
        $neckId = $neckInfo->id;
        $tanggal = $neckInfo->tanggal;
        $nama = $neckInfo->nama;
        $mars = $neckInfo->mars;
        $bom = $neckInfo->bom;
        $qty = $neckInfo->qty;
        $mesin = $neckInfo->mesin;
        $wo = $neckInfo->wo;
        $io = $neckInfo->io;
        $status = $neckInfo->status;
        ?>
        <h1>
            <i class="fa fa-user-circle-o" aria-hidden="true"></i> Neck Management
            <small>Edit Neck</small>
        </h1>
    </section>
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit Neck Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->

                    <form role="form" action="<?php echo base_url() ?>neck/editNeck" method="post" id="editNeck"
                        role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $neckId; ?>" name="neckId" id="neckId" />
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            <option value="pending" <?php echo isset($neck['status']) && $neck['status'] == 'pending' ? 'selected' : ''; ?>>Pending</option>
                                            <option value="complete" <?php echo isset($neck['status']) && $neck['status'] == 'complete' ? 'selected' : ''; ?>>Complete</option>
                                        </select>
                                    </div>
