<div class="content-wrapper">
    ...
    <section class="content-header">
        <?php
        $body3Id = $body3Info->id;
        $tanggal = $body3Info->tanggal;
        $nama = $body3Info->nama;
        $mars = $body3Info->mars;
        $bom = $body3Info->bom;
        $qty = $body3Info->qty;
        $mesin = $body3Info->mesin;
        $wo = $body3Info->wo;
        $io = $body3Info->io;
        $status = $body3Info->status;
        ?>
        <h1>
            <i class="fa fa-user-circle-o" aria-hidden="true"></i> Body3 Management
            <small>Edit Body3</small>
        </h1>
    </section>
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit Body3 Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->

                    <form role="form" action="<?php echo base_url() ?>body3/editBody3" method="post" id="editBody3"
                        role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $body3Id; ?>" name="body3Id"
                                            id="body3Id" />
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            <option value="pending" <?php echo isset($body3['status']) && $body3['status'] == 'pending' ? 'selected' : ''; ?>>Pending</option>
                                            <option value="complete" <?php echo isset($body3['status']) && $body3['status'] == 'complete' ? 'selected' : ''; ?>>Complete</option>
                                        </select>
                                    </div>
